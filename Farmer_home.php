...
<body class="flex bg-black">
    ...
    <div class="ml-[160px] h-[100vh] w-full p-1 overflow-y-auto bg-gray-900">
        <p class="font-bold text-xl text-white text-center p-2">Add Agriculture Work</p>
        ...
        if (isset($_POST['submit'])) {
            ...
            $add = $_POST["add"];
            $city = $_POST["city"];
            $sql = "insert into labour values('$name','$wage','$type','$phno','$add','$city')";
            if ($conn->query($sql)) {
        ...
        ?>
        <table class="table table-dark table-hover bg-netural-400/10 bg-opacity-70">
